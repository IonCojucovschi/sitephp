...
/////   api/login/login/admin/password/admin
  ...
  ///  echo var_dump($Param);////verify params 
	...
	$qr=mysqli_fetch_assoc(mysqli_query($CONNECT, "SELECT `id`,`name`,`surname`,`Email`,`cellphone`,`login`,`pasword`,`active` FROM `Users` WHERE login='$Param[login]' AND pasword='$Param[password]'"));
