...
/////forma url    api/login/loginul_var/param/paasdas.asdasd.asd
...
foreach ($Exp as $key) if($Param!='all' and !in_array($key,$Array)) Error(3,'parametrii nu sunt introdusi corect');
